...
DEFAULT_SERVER_WIDE_MODULES = ["base", "rpc", "web", "base_setup", "auth_signup", "auth_oauth", "iap", "iap_mail", "utm", "phone_validation", "onboarding", "mail", "mailing", "calendar", "project", "crm", "sales_team", "link_tracker", "partner_autocomplete", "helpdesk", "fetchmail", "hr", "hr_attendance", "hr_recruitment", "hr_contract", "hr_expense", "hr_payroll", "hr_timesheet", "hr_work_entry", "hr_holidays", "resource", "knowledge", "uom", "product", "sale", "sale_management", "project_account", "sale_service", "sale_project", "sale_subscription", "stock", "stock_barcode", "purchase", "analytic", "account", "account_payment", "account_check_printing", "payment", "ai_assistant", "auth_totp", "bus", "website", "website_sale", "mrp", "fleet", "pos", "quality", "maintenance", "event", "contacts", "portal", "lunch", "rating", "portal_rating", "digest", "sms", "privacy_lookup", "web_tour", "delivery", "loyalty", "repair", "survey", "base_automation", "base_import", "data_recycle", "hr_skills", "sale_stock", "purchase_stock", "stock_account", "mrp_account", "mrp_subcontracting"]
