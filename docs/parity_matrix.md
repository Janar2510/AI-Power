...
| Phase 544 (account fiscal / multi-tax / partial — deferral) | Explicit non-goals until subtracks; see `docs/account_odoo19_gap_audit.md` | `docs/account_odoo19_gap_audit.md` | deferred | product scope |
