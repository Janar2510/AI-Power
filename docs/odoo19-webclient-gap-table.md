...
| Views | modular view packages + registries | metadata-driven; heavy logic in `main.js` / legacy | migrate dashboard/list/form/kanban into view-owned modules | **Partial (562+…+615)**: list **control panel**; **SearchModel** (**608**); **graph** (**609**), **pivot** (**614**), **calendar** (**615**) toolbars + pivot/calendar grid tokens; **kanban** card (**603**); **KPI strip** (**585**/**590**); **chatter** (**597**); **gantt/activity** (**604**); **field registry** (**610**); modular boundaries (**590**) when `modern_webclient.js` loads |
