(function () {
  ...
  function render(container, options) {
    ...
    if (!LCP || typeof LCP.buildSearchDropdownsHtml !== "function") {
      throw new Error("ListControlPanel missing: ensure list_control_panel_shim.js is loaded before list_view.js in web.assets_web.");
    }
    var reportName = h.getReportName ? h.getReportName(model) : null;
    var dropdownsHtml = LCP.buildSearchDropdownsHtml({
    ...
    var filtersHtml = LCP.buildQuickFiltersHtml({
      searchFilters: searchFilters,
      activeFilters: activeFilters,
      searchGroupBys: searchGroupBys,
      currentGroupBy: currentGroupBy,
