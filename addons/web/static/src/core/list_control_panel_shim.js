/**
 * Phase 650: classic-script shim for web.assets_web (no ESM `export`).
 * Mirrors app/list_control_panel.js so list_view.js always delegates HTML to ListControlPanel.
 */
(function () {
